...
$csvPath = "C:\Users\TravisCheney\Trusted Tech Team, Irvine\ProServices - Delivery - Clients\Interior Investments\20240812 - 365 Migration\usersMasterInterior.csv"

# Domains to remove from proxy addresses comma-separated
#$domainsToRemove = "contoso.com,contoso.io,contoso.net"
$domainsToRemove = "interiorinvestments.com"
# onmicrosoft.com domain
#$onmicrosoftDomain = "contoso.onmicrosoft.com"
$onmicrosoftDomain = "interiorinvestments.onmicrosoft.com"
