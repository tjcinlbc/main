...
$Userlist = Import-Csv -Path "C:\Users\TravisCheney\Trusted Tech Team, Irvine\ProServices - Delivery - Clients\BITE Investments\20240520 - 365 Migration\usersEUaliases.csv" | foreach {
    $Data = [PSCustomObject]@{
        ...
        newUPN = $_."new UPN" # Assuming there's a "new UPN" column in the CSV
